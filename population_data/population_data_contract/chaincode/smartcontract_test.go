...
import (
	...
	"github.com/ildarzinatulin/fabric-samples/population-data/chaincode/mocks"
...
func TestInitLedger(t *testing.T) {
	...
	populationData := chaincode.SmartContract{}
	err := populationData.InitLedger(transactionContext)
